...
export default function SearchClient({ initial, q, sort, total }: Props) {
  ...
  return (
    <div>
      ...
      <ul role="list" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6" aria-live="polite">
        {items.map(item => (
          <li key={item.id}>
