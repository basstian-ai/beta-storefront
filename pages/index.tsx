...
export async function getServerSideProps() {
  ...
  try {
    ...
    // Optionally, you could return a specific error prop to display on the page
    // or redirect to an error page
  }
  return { props: { categories } };
}

export default function Home({ categories }: HomeProps) { // Use HomeProps
  return (
    <Layout categories={categories}> {/* Wrap content with Layout */}
      <Head>
