...
// Local extras that supplement dummyjson data. They omit base fields
// like name or price to ensure we always rely on DummyJSON for
...
export async function fetchProductDetailsById(
  ...
  try {
    ...
    const local = (MOCK_PRODUCT_DETAILS_JSON as unknown as ProductExtras[]).find(
