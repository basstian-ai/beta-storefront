...
import { ProductSchema, ServiceProductsResponseSchema } from '@/bff/types'; // Assuming Product type is needed
import { z } from 'zod';
        ...
        <Combobox value={selectedProduct} onChange={(product) => {
          ...
          <div className="relative mt-1">
            ...
            <Transition
              ...
              leaveTo="opacity-0"
              afterLeave={() => { if(query.length < 3) setFilteredProducts([])}} // Clear suggestions if query is too short after transition
            >
